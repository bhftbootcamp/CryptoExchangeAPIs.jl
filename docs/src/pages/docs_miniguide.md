...
In the [`Supported Exchange APIs`](https://github.com/bhftbootcamp/CryptoExchangeAPIs.jl/blob/master/README.md#supported-exchange-apis) table in the README.md you need to add a new row with links to relevant resources:
```html
...
<tr>
...
Similar to [adding a new exchange](@ref new_exchange), you need to add a new row to the table with [`Supported Exchange APIs`](https://github.com/bhftbootcamp/CryptoExchangeAPIs.jl/blob/master/README.md#supported-exchange-apis) (in the README.md and on the main page of the documentation `docs/src/index.md`) corresponding to the new type of market.
