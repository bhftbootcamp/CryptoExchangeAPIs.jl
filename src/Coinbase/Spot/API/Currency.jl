...
struct CurrencyDetails <: CoinbaseData
    type::Maybe{String}
    symbol::Maybe{String}
    network_confirmations::Maybe{Int32}
...
struct CurrencyData <: CoinbaseData
    id::String
    name::Maybe{String}
...
```
"""
function currency(client::CoinbaseClient, query::CurrencyQuery)
    return APIsRequest{Vector{CurrencyData}}("GET", "currencies", query)(client)
end

function currency(client::CoinbaseClient = Coinbase.Spot.public_client; kw...)
