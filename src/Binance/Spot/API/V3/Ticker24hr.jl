...
"""
    ...
    ticker24hr(client::BinanceClient = Binance.Spot.public_client; kw...)
...
result = Binance.Spot.API.V3.ticker24hr(;
    symbol = "ADAUSDT",
) 
...
function ticker24hr(client::BinanceClient = Binance.Spot.public_client; kw...)
