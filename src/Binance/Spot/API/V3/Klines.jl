...
"""
    ...
    klines(client::BinanceClient = Binance.Spot.public_client; kw...)
...
result = Binance.Spot.API.V3.klines(;
    symbol = "ADAUSDT",
    interval = Binance.Spot.API.V3.Klines.TimeInterval.M1,
) 
...
function klines(client::BinanceClient = Binance.Spot.public_client; kw...)
