...
"""
    ...
    depth(client::BinanceClient = Binance.Spot.public_client; kw...)
...
result = Binance.Spot.API.V3.depth(;
    symbol = "ADAUSDT"
)
...
function depth(client::BinanceClient = Binance.Spot.public_client; kw...)
