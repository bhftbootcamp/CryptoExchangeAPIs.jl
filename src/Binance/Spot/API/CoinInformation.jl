...
struct CoinInformationData <: BinanceData
    coin::String
...
```
"""
function coin_information(client::BinanceClient, query::CoinInformationQuery)
    return APIsRequest{Vector{CoinInformationData}}("GET", "sapi/v1/capital/config/getall", query)(client)
end

function coin_information(client::BinanceClient; kw...)
