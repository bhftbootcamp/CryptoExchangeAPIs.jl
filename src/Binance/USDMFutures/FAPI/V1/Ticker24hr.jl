...
"""
    ...
    ticker24hr(client::BinanceClient = Binance.USDMFutures.public_client; kw...)
...
result = Binance.USDMFutures.FAPI.V1.ticker24hr(;
    symbol = "ADAUSDT",
) 
...
function ticker24hr(client::BinanceClient = Binance.USDMFutures.public_client; kw...)
