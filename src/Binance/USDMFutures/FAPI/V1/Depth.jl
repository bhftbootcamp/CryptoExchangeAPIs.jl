...
"""
    ...
    depth(client::BinanceClient = Binance.USDMFutures.public_client; kw...)
...
result = Binance.USDMFutures.FAPI.V1.depth(;
    symbol = "ADAUSDT"
) 
...
function depth(client::BinanceClient = Binance.USDMFutures.public_client; kw...)
