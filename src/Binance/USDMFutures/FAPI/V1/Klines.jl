...
"""
    ...
    klines(client::BinanceClient = Binance.USDMFutures.public_client; kw...)
...
result = Binance.USDMFutures.FAPI.V1.klines(;
    symbol = "ADAUSDT",
    interval = Binance.USDMFutures.FAPI.V1.Klines.TimeInterval.M1,
) 
...
function klines(client::BinanceClient = Binance.USDMFutures.public_client; kw...)
