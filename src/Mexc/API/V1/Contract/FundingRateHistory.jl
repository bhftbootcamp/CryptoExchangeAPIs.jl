...
"""
    ...
    funding_rate_history(client::MexcClient = MexcFuturesClient(Mexc.public_futures_config); kw...)
...
function funding_rate_history(client::MexcClient = MexcFuturesClient(Mexc.public_futures_config); kw...)
